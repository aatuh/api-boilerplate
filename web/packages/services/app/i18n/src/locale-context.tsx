...
import { createLocaleProvider, useLocale as useSharedLocale } from "@api-boilerplate/i18n-shared/locale-context";
...
export type RawTranslator = (key: string, params?: Record<string, string | number>) => string;
export type ValueTranslator = (key: string, params?: Record<string, string | number>) => unknown;
