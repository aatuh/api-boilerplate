import { createHttpClient, type HttpClient } from "@api-boilerplate/http";
import { apiBase } from "@api-boilerplate/app-config";
import type { components } from "../../../../../../../../.trash/xtypes";
