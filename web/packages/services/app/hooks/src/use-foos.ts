...
import { resolveHttpErrorMessage } from "@api-boilerplate/http/errors";
import { useLocale } from "@api-boilerplate/app-i18n";
...
export function useFooList(filters: FooListRequest, deps?: FooDeps) {
  ...
  const stableFilters = useMemo(
    ...
    [filters.orgId, filters.namespace, filters.limit, filters.offset, filters.search]
  );
